...
- [ ] F2 live collector running ≥14 days — collector built + live-verified 2026-07-19 ([collector/live_collector.py](../collector/live_collector.py), panel [analysis/status.py](../analysis/status.py)); VPS deployment in progress (ADR-0007, Oracle instance pending capacity) — the 14-day clock starts on the VPS
